...
#define GET(s)    (*(volatile FxU32 *)&(s))
#define GET16(s)  (*(volatile FxU16 *)&(s))
#define SET(d,s)  (*(volatile FxU32 *)&(d) = (FxU32)(s))
#define SET16(d,s) (*(volatile FxU16 *)&(d) = (FxU16)(s))
#define SETF(d,s) (*(volatile float *)&(d) = (s))
#else
#define GET(s) s
#define GET16(s) s
#define SET(d,s) d = s
